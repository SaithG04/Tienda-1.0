...
public class ProductosPanel extends javax.swing.JPanel {
    ...
    private static ProductosPanel instancia;
    ...
    private void initComponents() {
        ...
        add(lblRecuperar3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 490, 220, 40));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 10, 440, 520));

        txtCantidad.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        add(txtCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 230, 260, 50));

        txtProducto.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        add(txtProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 20, 260, 50));

        txtTipo.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        add(txtTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 90, 260, 50));

        jLabel5.setFont(new java.awt.Font("Swis721 BT", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel5.setText("CANTIDAD:");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 210, 110, 80));
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 10, 110, 80));

        jLabel7.setFont(new java.awt.Font("Swis721 BT", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel7.setText("UND MEDIDA:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 70, 110, 80));

        jLabel8.setFont(new java.awt.Font("Swis721 BT", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("PROVEEDOR:");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 110, 80));

        cbProveedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<SELECCIONAR>" }));
        add(cbProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 160, 260, 50));
        ...
        add(btninicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 440, 140, 40));
        ...
        add(btnAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 370, 140, 40));
        ...
        add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 370, 140, 40));
        ...
        add(tbnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 440, 140, 40));

        jLabel9.setFont(new java.awt.Font("Swis721 BT", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel9.setText("PRECIO:");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 280, 110, 80));

        txtPrecio.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        add(txtPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 300, 260, 50));
    }// </editor-fold>//GEN-END:initComponents

    public static ProductosPanel getProcPanel() {
        if (instancia == null) {
            instancia = new ProductosPanel();
        }
        return instancia;
    }
